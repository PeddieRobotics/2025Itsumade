...
public class RotateTx extends Command {
  ...
  public void execute() {
    ...
    rotationalError = setpoint - currentTX;

    drivetrain.drive(new Translation2d(0,0), pidController.calculate(rotationalError, 0), false, null);
  }
