...
public class Kraken {
    ...
    public void setVelocityPIDValues(double kS, double kV, double kA, double kP, double kI, double kD, double kF, StaticFeedforwardSignValue ffs) {
        // TODO: update kraken methods to include kG, cosine mode
        config.Slot0.StaticFeedforwardSign = ffs;
